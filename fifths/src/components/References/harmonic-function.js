    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle={{flexGrow:1}}>
        <View style={{ flex:1 }}>
          ...
          <Text style={styles.paragraph}> When moving clockwise ("down") on the Circle of Fifths, move by step only. Stepwise means moving to an adjacent chord. For example a C chord should step down  to an F chord rather than leap down to a Bb chord. To move from a D chord to C, first step down to G, then step down  again to C. D does not “want” to leap down to C, it “wants” to step down to G. Leaping down directly from D to C will weaken the sense of musical gravity.
          </Text>
